(function($) {
  ...
  // header
  (function () {
    var menulink =$('.menu-panel__menu-link')
    var topmenulink =$('.top-menu__menu-link')
    ...
    menulink.on('click', function () {
      ...
      /* Navbar scroll*/
        ...
        if (target.length) {
            ...
            $('.menu-panel__menu-link').removeClass('menu-panel__menu-link_active');
            $(this).addClass('menu-panel__menu-link_active');
            hideMenu();
            return false;
        }
        hideMenu();
